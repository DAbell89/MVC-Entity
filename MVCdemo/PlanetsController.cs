...
namespace MVCdemo
{
    public class PlanetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlanetID,Name,Population,Faction")] Planet planet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlanetID,Name,Population,Faction")] Planet planet)
        {
            if (ModelState.IsValid)
            {
